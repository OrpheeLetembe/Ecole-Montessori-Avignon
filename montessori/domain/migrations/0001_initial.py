    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_start', models.CharField(max_length=5)),
                ('letter_a', models.CharField(max_length=250, verbose_name='A')),
                ('letter_b', models.CharField(max_length=250, verbose_name='B')),
                ('letter_c', models.CharField(max_length=250, verbose_name='C')),
                ('letter_d', models.CharField(max_length=250, verbose_name='D')),
                ('letter_e', models.CharField(max_length=250, verbose_name='E')),
                ('letter_f', models.CharField(max_length=250, verbose_name='F')),
                ('letter_g', models.CharField(max_length=250, verbose_name='G')),
                ('letter_h', models.CharField(max_length=250, verbose_name='H')),
                ('letter_i', models.CharField(max_length=250, verbose_name='I')),
                ('letter_j', models.CharField(max_length=250, verbose_name='J')),
                ('letter_k', models.CharField(max_length=250, verbose_name='K')),
                ('letter_l', models.CharField(max_length=250, verbose_name='L')),
                ('letter_m', models.CharField(max_length=250, verbose_name='M')),
                ('letter_n', models.CharField(max_length=250, verbose_name='N')),
                ('letter_o', models.CharField(max_length=250, verbose_name='O')),
                ('letter_p', models.CharField(max_length=250, verbose_name='P')),
                ('letter_q', models.CharField(max_length=250, verbose_name='Q')),
                ('letter_r', models.CharField(max_length=250, verbose_name='R')),
                ('letter_s', models.CharField(max_length=250, verbose_name='S')),
                ('letter_t', models.CharField(max_length=250, verbose_name='T')),
                ('letter_u', models.CharField(max_length=250, verbose_name='U')),
                ('letter_v', models.CharField(max_length=250, verbose_name='V')),
                ('letter_w', models.CharField(max_length=250, verbose_name='W')),
                ('letter_x', models.CharField(max_length=250, verbose_name='X')),
                ('letter_y', models.CharField(max_length=250, verbose_name='Y')),
                ('letter_z', models.CharField(max_length=250, verbose_name='Z')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.students')),
            ],
            options={
                'verbose_name': 'Lettre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_4', models.CharField(default='ETUDE DE MOT', max_length=100)),
